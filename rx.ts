...
export function polling(func, router: Router, tick: Function, tick_param: any = null, freq: number = 1000 * 60 * 1 /*1 min*/, before: Function = null, after: Function = null, error: Function = null, complete: Function = null): Subscriber<Response> {
  let req: Function
  let pass: Function
